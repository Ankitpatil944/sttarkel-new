...
//     { name: "Try Placemate", path: "https://placemate-70dm.onrender.com/auth/login", external: true },
//   ];
...
//     <nav className="fixed top-8 left-1/2 -translate-x-1/2 w-[95%] md:w-11/12 z-50 bg-background/100 backdrop-blur-md border border-blue-100 rounded-3xl px-2 sm:px-4">
