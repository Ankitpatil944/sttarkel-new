...
//     <div
//       className="min-h-screen max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 m-2 sm:m-2 lg:m-5 border border-blue-300 rounded-3xl overflow-hidden bg-gradient-to-b from-slate-100 to-cyan-50 animate-fade-in"
//       style={{ marginTop: '0.8rem' }}
//     >
//       {/* Hero Section */}
//       <section className="relative pt-24 mt-10 pb-20">
...
//             <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fade-in relative">
//               <div 
